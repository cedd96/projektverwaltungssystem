...
public class OrganisationOverviewBorderPane extends BorderPane {
    public OrganisationOverviewBorderPane() throws SQLException {
        ...
        setCenter(new OrganisationListBorderPane());
    }
}
