...
public class ModulComparator implements Comparator<GroupListViewItemVBox> {
        ...
        if(w1 != null && w2 != null) {
            try {
                if(w1.getGruppe().getModul() != null && w2.getGruppe().getModul() != null){
                    return w1.getGruppe().getModul().getModulname().compareToIgnoreCase(w2.getGruppe().getModul().getModulname());
                }
